    ...
    <main class="d-flex gap-2 m-2">
        <aside id="asideBar" class=" p-2 ml-2">
            <div class="nav flex-column" >
                ...
                <a href="item.html"  class="nav-link rounded-1 fw-bold mt-2 p-3 active"  >
          ...
          <table class="mt-3 table align-middle mb-0 bg-white">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-shield-x cursor-pointer" viewBox="0 0 16 16">
