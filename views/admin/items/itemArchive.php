<?php 
    ...
    <td >
        ...
        ?>
        <svg onclick="archiveItem(<?=$items[$i]['wikiID']?>)" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" style="fill: red;" class="bi bi-shield-x cursor-pointer" viewBox="0 0 16 16">
