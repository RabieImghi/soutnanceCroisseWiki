                ...
                <div class="profile d-flex gap-4 align-items-center">
                    ...
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                            <?php 
                            if(isset($_SESSION['role_user']) && $_SESSION['role_user']=="author"){
                                ?>
                                <li><a class="dropdown-item" href="<?=$_ENV['APP_URL']."/"?>">Home</a></li>
                                <?php
                            }
                            ?>
    ...
    <main class="d-flex gap-2 m-2">
        <aside id="asideBar" class=" p-2 mx-1">
            <div class="nav flex-column" >
                ...
                ?>
                <a href="<?=$_ENV['APP_URL']."/"?>"  class="nav-link rounded-1 fw-bold mt-2 p-3 <?php if(isset($dashboard))echo "active"; ?>" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-up-arrow" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M0 0h1v15h15v1H0zm10 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4.9l-3.613 4.417a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61L13.445 4H10.5a.5.5 0 0 1-.5-.5"/>
                    </svg>
                    <span class="ml-2">Dashboard</span>
                </a>
                <a href="<?=$_ENV['APP_URL']."/AdminItems"?>"  class="nav-link rounded-1 fw-bold mt-2 p-3 <?php if(isset($itemss))echo "active"; ?>"  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-view-list" viewBox="0 0 16 16">
                        <path d="M3 4.5h10a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1zM1 2a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 2m0 12a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 14"/>
                    </svg>
                    <span class="ml-2">Items List</span>
                </a>
                <a href="<?=$_ENV['APP_URL']."/TagsLists"?>"  class="nav-link rounded-1 fw-bold mt-2 p-3 <?php if(isset($tags))echo "active"; ?>"  >
                ...
                <a href="<?=$_ENV['APP_URL']."/CategorysLists"?>"  class="nav-link rounded-1 fw-bold mt-2 p-3 <?php if(isset($category))echo "active"; ?>"  >
                ...
                ?>
                <a href="<?=$_ENV['APP_URL']."/"?>"  class="nav-link rounded-1 fw-bold mt-2 p-3 <?php if(isset($itemAuthour))echo "active"; ?>"  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-view-list" viewBox="0 0 16 16">
                        <path d="M3 4.5h10a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1zM1 2a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 2m0 12a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 14"/>
                    </svg>
