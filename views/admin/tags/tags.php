      ...
      <tr>
        ...
        <td >
          <div class='d-flex gap-2'>
            ...
            <svg data-bs-toggle="modal" data-bs-target="#updateTags<?=$tag['tagID']?>" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="cursor-pointer bi bi-pencil-square" viewBox="0 0 16 16">
              <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
              <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
            </svg>
          </div>
          
          <div class="modal fade" id="updateTags<?=$tag['tagID']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h2>Add New Tag</h2>
                ...
                <div class="modal-body">
                    <form action="<?=$_ENV['APP_URL']."/updateTags"?>" method="post">
                        <input type="text" value="<?=$tag['nameT']?>" class="form-control mt-3" name="Name" placeholder="Tag Name">
                        <textarea name="decription" id="" class="form-control  mt-3" rows="6"  placeholder="Tag Description"><?=$tag['decription']?></textarea>
                        <div class="button mt-3 mb-3 d-flex gap-2 justify-content-end">
                            <button type="submit" value="<?=$tag['tagID']?>" name="idTag" class="btn btn-outline-success">update</button>
                            <button type="reset"  data-bs-dismiss="modal" class="btn btn-outline-dark">Close</button>
                        </div>
                    </form>
                </div>
